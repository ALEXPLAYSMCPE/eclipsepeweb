...
<!--
    ...
    <div id="discord">
       <a href="https://discord.gg/5DwjpwW" target="_blank">
          <div class="dinfo">
             <h3><b><i class="fas fa-spinner fa-spin"></i></b> USERS CURRENTLY ONLINE ON DISCORD</h3>
             <h4>Become one of us today, click to join!</h4>
          </div>
       </a>
